...
if(isset($_POST['update_admin']) && isset($_SESSION['admin_logged_in'])){
...
if(isset($_POST['send_email']) && isset($_SESSION['admin_logged_in'])){
...
// ===== ADD PHOTO =====
if(isset($_POST['submit_form']) && $_POST['submit_form'] === 'add_photo' && isset($_SESSION['admin_logged_in'])){
